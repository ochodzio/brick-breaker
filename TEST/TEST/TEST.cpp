        ...
        if (gameStarted&&!gameOver)
        {
                ...
                while (window.isOpen())
                {
                    ...
                    for (int i = 0; i < n; i++)
                        ...
                        {
                            if (y + 6 > block[i].sprite.getPosition().y && y + 6 < block[i].sprite.getPosition().y + blockHight) {
                                // Ball hit the left or right side of the block
                                dx = -dx;;
                            }
                            else if (x + 6 > block[i].sprite.getPosition().x && x + 6 < block[i].sprite.getPosition().x + blockWidth) {
